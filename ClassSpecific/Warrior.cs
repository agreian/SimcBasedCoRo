...
namespace SimcBasedCoRo.ClassSpecific
{
    ...
    public class Warrior : ClassSpecificBase
    {
        ...
        private static readonly Func<Func<bool>, Composite> bloodbath = cond => Spell.BuffSelfAndWait(WarriorSpells.bloodbath, req => Spell.UseCooldown && cond());
        ...
        private static readonly Func<Func<bool>, Composite> recklessness = cond => Spell.BuffSelfAndWait(WarriorSpells.recklessness, req => Spell.UseCooldown && cond());
        ...
        private static readonly Func<Func<bool>, Composite> sweeping_strikes = cond => Spell.BuffSelfAndWait(WarriorSpells.sweeping_strikes, req => Spell.UseAoe && cond());
